...
WebUI.click(findTestObject('Object Repository/Page_CamNest/i_Contact_fas fa-user (75)'))
...
WebUI.click(findTestObject('Object Repository/Page_CamNest/button_submit (56)'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard Manager - CamNest Admin/a_Account_nav-link (13)'))

WebUI.click(findTestObject('Object Repository/Page_Advanced Product Manager - CamNest/input_So snh s lng sn phm theo nh cung cp_s_6477d0 (4)'))
