...
ExtendedKeywords.safeClickLoginIcon(findTestObject('Object Repository/Page_CamNest/i_Contact_fas fa-user (80)'))
...
ExtendedKeywords.safeClick(findTestObject('Object Repository/Page_CamNest/button_submit (61)'))

ExtendedKeywords.safeClick(findTestObject('Object Repository/Page_Dashboard Manager - CamNest Admin/a_Account_nav-link (18)'))
...
ExtendedKeywords.safeClick(findTestObject('Object Repository/Page_Advanced Product Manager - CamNest/button_Add Product_btn btn-secondary (2)'))
