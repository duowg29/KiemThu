...
WebUI.click(findTestObject('Object Repository/Page_CamNest/i_Contact_fas fa-user (41)'))

WebUI.click(findTestObject('Object Repository/Page_CamNest/label_Or_toggleLabel (6)'))
...
WebUI.click(findTestObject('Object Repository/Page_CamNest/input__acceptEULA (1)'))

WebUI.click(findTestObject('Object Repository/Page_CamNest/button_Subscribe for news_signupButton (2)'))

WebUI.click(findTestObject('Object Repository/Page_Thng bo kim tra Email/a_Vui lng kim tra email  xc nhn ng k_btn-custom'))

WebUI.setText(findTestObject('Object Repository/Page_Gmail/input_to continue to Gmail_identifierId'), '25a4041902@hvnh.edu.vn')

WebUI.click(findTestObject('Object Repository/Page_Gmail/span_Learn more about using Guest mode_VfPp_231d3e'))
...
WebUI.click(findTestObject('Object Repository/Page_Inbox (16) - 25a4041902hvnh.edu.vn - H_19f46d/div_CAMNEST  Xc nhn ti khon  08 Dec 2025, 1_9646b0'))

WebUI.click(findTestObject('Object Repository/Page_CAMNEST  Xc nhn ti khon  08 Dec 2025, _7e3502/a_CamNest_m_-3443156591798166017button'))
