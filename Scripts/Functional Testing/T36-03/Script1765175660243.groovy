...
ExtendedKeywords.safeClick(findTestObject('Object Repository/Page_CamNest/button_submit (105)'))

ExtendedKeywords.safeClick(findTestObject('Object Repository/Page_Dashboard Manager - CamNest Admin/a_Product_nav-link (22)'))
...
ExtendedKeywords.safeClick(findTestObject('Object Repository/Page_Advanced Order Management - CamNest/button__btn btn-secondary'))
