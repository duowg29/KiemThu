...
WebUI.click(findTestObject('Object Repository/Page_CamNest/i_Contact_fas fa-user (122)'))
...
WebUI.click(findTestObject('Object Repository/Page_CamNest/button_submit (104)'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard Manager - CamNest Admin/a_Product_nav-link (21)'))

WebUI.click(findTestObject('Object Repository/Page_Advanced Order Management - CamNest/button_Doanh thu theo phng thc thanh ton_bt_8cb3d1 (2)'))
