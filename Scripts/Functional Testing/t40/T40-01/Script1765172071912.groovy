...
ExtendedKeywords.safeClickLoginIcon(findTestObject('Object Repository/Page_CamNest/i_Contact_fas fa-user (89)'))
...
ExtendedKeywords.safeClick(findTestObject('Object Repository/Page_CamNest/button_submit (70)'))

ExtendedKeywords.safeClick(findTestObject('Object Repository/Page_Dashboard Manager - CamNest Admin/a_Order_nav-link (7)'))
...
ExtendedKeywords.safeClick(findTestObject('Object Repository/Page_CamNest/input_Target_all (1)'))
