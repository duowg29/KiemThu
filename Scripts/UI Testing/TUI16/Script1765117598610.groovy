...
ExtendedKeywords.safeClick(findTestObject('Object Repository/Page_CamNest/a (25)'))

ExtendedKeywords.safeClick(findTestObject('Object Repository/Page_CamNest - Camera/i_My nh k thut s Sony ZV-E10_far fa-cart-plus cart (7)'))

ExtendedKeywords.safeClick(findTestObject('Object Repository/Page_CamNest - Camera/i_Contact_fas fa-shopping-cart (8)'))
